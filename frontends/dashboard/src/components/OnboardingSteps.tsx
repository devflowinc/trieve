...
export const OnboardingSteps = (props: OnboardingStepsProps) => {
  const activeDataset = createMemo(() => {
    if ((props.orgUsage()?.dataset_count ?? 0) == 0) {
      return 1;
    } else if ((props.orgUsage()?.chunk_count ?? 0) == 0) {
      return 2;
    }
                ...
                <span class="flex items-start px-6 py-5 text-sm">
                  ...
                  <span class="ml-4 mt-0.5 flex min-w-0 flex-col">
                    ...
                    <span class="text-sm">
                      ...
                      Dataset is encrypted and isolated from other Datasets. API
                      keys and requests are scoped to a specific Dataset. Click
                      on the{" "}
              ...
              <div>
                ...
                <span class="flex items-start px-6 py-5 text-sm lg:pl-9">
                  ...
                  <span class="ml-4 mt-0.5 flex min-w-0 flex-col">
                    ...
                    >
                      Once you have a Dataset, you must populate it. You can add
                      Chunks or Upload Files without code using the{" "}
                      <a
                ...
                <span class="flex items-start px-6 py-5 text-sm lg:pl-9">
                  ...
                  <span class="ml-4 mt-0.5 flex min-w-0 flex-col">
                    ...
                    >
                      ...
                      and{" "}
                      <a class="inline underline" href="https://chat.trieve.ai">
                        Chat
                      </a>{" "}
