...
!(function () {
  ...
  const an = (e, t, o) => (e.stype === sn.Error ? t(e.serror) : o(e.svalue)),
    ...
    On = (e) => ({
      extract: (t, o) =>
        ((e, t) => (e.stype === sn.Error ? t(e.serror) : e))(e(o), (e) =>
          ((e, t) => kn(e, x(t)))(t, e),
        ),
      toString: x("val"),
    }),
        ...
        a = (e) =>
          e.fold(
            ...
            (e) =>
              ((e, t) =>
                e.stype === sn.Value
                  ? { stype: sn.Value, svalue: t(e.svalue) }
      ...
      return {
        extract: (t, n) => {
          ...
          for (const s of e) {
            ...
            if (e.stype === sn.Value)
              return { stype: sn.Value, svalue: o(e.svalue) };
            r.push(e);
          }
          return wn(r);
        },
    ...
    qn = (e, t, o) => {
      return (
        (n = ((e, t, o) =>
          ((e, t) =>
            e.stype === sn.Error
              ? { stype: sn.Error, serror: t(e.serror) }
  ...
  const la = (e) => {
    ...
    va = ba(),
    ya = (e) =>
      H(e, (e) => (Ae(e, "/*") ? e.substring(0, e.length - "/*".length) : e)),
    xa = (e, t) => {
      const o = e.toString(),
        n = o.indexOf(")") + 1,
        r = o.indexOf("("),
      ...
      return (
        (e.toFunctionAnnotation = () => ({ name: t, parameters: ya(s) })), e
      );
    },
    wa = la("alloy-premade"),
    Sa = (e) => (
      ...
      ((e, t) => {
        ...
        return o.errors.length > 0
          ...
          : ((e, t) =>
              0 === e.length
                ? rn.value(t)
                : rn.value(fn(t, bn.apply(void 0, e))))(o.values, t);
        var n;
      })(
        pe(e, (e, o) =>
  ...
  var ii,
    li = (e, t, o, n, r) =>
      e(o, n) ? A.some(o) : p(r) && r(o) ? A.none() : t(o, n, r);
  const ci = (e, t, o) => {
      let n = e.dom;
      const r = p(o) ? o : T;
      for (; n.parentNode; ) {
  ...
  var vl = Object.freeze({
    ...
    yl = [
      nr("channels", $n(rn.value, Mn([Fi("onReceive"), yr("schema", Nn())]))),
    ];
  const xl = (e, t, o) =>
      Zs((n, r) => {
        o(n, e, t);
                  ...
                  const a = (t) => {
                      ...
                      const n =
                        null !== (o = t.raw.pseudoElement) && void 0 !== o
                          ...
                          : "";
                      return (
                        Ze(t.target, e) && !De(n) && R(rc, t.raw.propertyName)
                      );
                    },
                    i = (s) => {
                      if (m(s) || a(s)) {
                        ...
                        (m(a) || a === os()) &&
                          (clearTimeout(r), Et(e, sc), ja(e, t.classes));
                      }
                    },
                    l = tc(e, ns(), (t) => {
                      a(t) &&
  ...
  const yc = "data-alloy-vertical-dir",
    xc = (e) =>
      ui(
        e,
        (e) => Ge(e) && Ct(e, "data-alloy-vertical-dir") === vc.BottomToTop,
      ),
    wc = () =>
      vr("layouts", [
        or("onLtr"),
  ...
  const hd = [
      dr("classes", Hn),
      kr("mode", "all", ["all", "layout", "placement"]),
    ],
  ...
  var Ud = Object.freeze({
      ...
      isOpen: Hd,
      isPartOf: (e, t, o, n) =>
        Hd(0, 0, o) && o.get().exists((o) => t.isPartOf(e, o, n)),
    ...
    jd = [
      ...
      or("isPartOf"),
      or("getAttachPoint"),
      yr("cloakVisibilityAttr", "data-precloak-visibility"),
    ],
    Gd = Object.freeze({
      __proto__: null,
      init: () => {
  ...
  const $d = Cl({
    ...
    Yd = Mn([
      yr("isExtraPart", T),
      vr("fireEventInstead", [yr("event", Os())]),
    ]),
    Jd = (e) => {
  ...
  var lu = [
    ...
    uu = [
      xr(
        "store",
        { mode: "memory" },
        Jn("mode", { memory: du, manual: cu, dataset: lu }),
      ),
      Di("onSetValue"),
      yr("resetOnDom", !1),
    ];
      ...
      ((e, t, o) => {
        ...
        return (
          L(o, (e) => {
            e.fold(
              (e) => {
                n[e.pname] = Su(!0, (t, o, n) =>
                  e.factory.sketch($u(t, e, o, n)),
                );
              },
              (e) => {
  ...
  const cm = (e, t, o, n, r) => {
    ...
    fm = (e) =>
      (Ke("input")(e) && "radio" !== Ct(e, "type")) || Ke("textarea")(e);
  ...
  const vm = [or("find")],
    ...
    Am = (e, t) =>
      Sm(e, t)
        ...
        : ((e) => "true" === Ct(e.element, "aria-disabled"))(e);
  ...
  const Fm = Cl({ fields: Bm, name: "disabling", active: Dm, apis: Mm }),
    ...
    Rm = (e, t, o, n) => {
      Im(e, t, 0, [n]),
        Nm(e, t, o, n) ||
          (La(n.element, t.highlightClass), t.onHighlight(e, n), Fs(n, Ds()));
    },
  ...
  var Pm = Object.freeze({
      ...
      dehighlight: (e, t, o, n) => {
        Nm(e, t, o, n) &&
          (Pa(n.element, t.highlightClass), t.onDehighlight(e, n), Fs(n, Bs()));
      },
      highlight: Rm,
  ...
  const Wm = Cl({ fields: Um, name: "highlighting", apis: Pm }),
    ...
    cg = (e, t, o) => {
      t.exists((e) => o.exists((t) => Ze(t, e))) ||
        Is(e, _s(), { prevFocus: t, newFocus: o });
    },
    dg = () => {
  ...
  const bg = (e, t, o) =>
      fm(o) && ng(Xm)(t.event)
        ? A.none()
        : ((e, t, o) => (Ns(e, o, us()), A.some(!0)))(e, 0, o),
    vg = (e, t) => A.some(!0),
    yg = [
      yr("execute", bg),
      yr("useSpace", !1),
      yr("useEnter", !0),
      yr("useControlEnter", !1),
      yr("useDown", !1),
    ],
  ...
  var wg = gg(
    ...
    (e, t, o, n) => {
      ...
      return [lg(ng(i), xg)].concat(
        o.useControlEnter ? [lg(rg([ag, ng($m)]), xg)] : [],
      );
    },
  ...
  const Kg = (e, t, o, n, r) => {
      const s = (e, t, o) =>
        r(e, t, n, 0, o.length - 1, o[t], (t) => {
          return (
            (n = o[t]),
            "button" === Ue(n) && "disabled" === Ct(n, "disabled")
              ? s(e, t, o)
              : A.from(o[t])
          );
          var n;
    ...
    np = (e) => (t, o, n, r) =>
      e(t, o, n, r).bind(() => (n.executeOnMove ? Qg(t, o, n) : A.some(!0))),
    rp = x([lg(ng(Xm), vg), lg(ng(qm), (e, t, o) => o.onEscape(e, t))]);
  var sp = gg(
    Zg,
    Ca.init,
    (e, t, o, n) => {
      const r = [...(o.allowHorizontal ? Km : [])].concat(
          o.allowVertical ? Ym : [],
        ),
        s = [...(o.allowHorizontal ? Jm : [])].concat(
          o.allowVertical ? Zm : [],
        );
      return [
        lg(ng(r), np(Cg(tp, op))),
  ...
  const wp = [or("selector"), yr("execute", bg), yr("moveOnTab", !1)],
    ...
    _p = x([
      lg(ng(Ym), Dg(Op)),
      lg(ng(Zm), Dg(Cp)),
      lg(rg([sg, ng(Gm)]), (e, t, o, n) =>
        o.moveOnTab ? Dg(Op)(e, t, o, n) : A.none(),
      ),
      lg(rg([ig, ng(Gm)]), (e, t, o, n) =>
        o.moveOnTab ? Dg(Cp)(e, t, o, n) : A.none(),
      ),
      lg(ng($m), Sp),
      lg(ng(Xm), Sp),
    ]),
  ...
  const ch = () => {
    ...
    ph = (e) => {
      (Rl(e.element).isNone() || eh.isFocused(e)) &&
        (eh.isFocused(e) || eh.focus(e), Is(e, uh, { item: e }));
    },
    hh = (e) => {
      Is(e, mh, { item: e });
    },
                    ...
                    n.lookupMenu(a).bind((i) => {
                      ...
                      return (
                        ...
                        s === m.HighlightSubmenu
                          ? (Wm.highlightFirst(l), u(t, n, r))
                          : (Wm.dehighlightAll(l), A.some(o))
                      );
                    }),
                  )
                ),
          ...
          f = Hs([
            ...
            Ys((t, o) => {
              ((t) => {
                ...
                Xp.append(t, ai(o)),
                  e.onOpenMenu(t, o),
                  e.highlightOnOpen === Nh.HighlightMenuAndItem
                    ? i(t, o)
                    : e.highlightOnOpen === Nh.HighlightJustMenu && a(t, o);
              });
            }),
            Us(Ih, (t, o) => {
        ...
        return {
          ...
          behaviours: hu(e.tmenuBehaviours, [
            Hp.config({
              mode: "special",
              onRight: h((e, t) =>
                fm(t.element) ? A.none() : g(e, t, m.HighlightSubmenu),
              ),
    ...
    Hh = pm({
      ...
      factory: (e, t) => {
        const o = (t, o, n, r) => {
            ...
            $d.openWhileCloaked(t, o, () =>
              xd.positionWithinBounds(s, t, n, r()),
            ),
              mu.setValue(
                t,
                A.some({ mode: "position", config: n, getBounds: r }),
              );
          },
          n = (t, o, n, r) => {
            const s = ((e, t, o, n, r) => {
              ...
              return zh.sketch({
                ...
                onEscape: () => (
                  $d.close(t), e.onEscape.map((e) => e(t)), A.some(!0)
                ),
                onExecute: () => A.some(!0),
                onOpenMenu: (e, t) => {
  ...
  const Ph = pm({
      ...
      factory: (e) => {
        ...
        return {
          ...
          components: e.components,
          events: t,
          behaviours: bu(e.buttonBehaviours, [
            eh.config({}),
  ...
  const jh = {
    ...
    qh = (e, t) => {
      ...
      if (Wh.isRtl()) {
        const e = ((e, t) => (Ae(e, t) ? e : ((e, t) => e + "-rtl")(e)))(
          o,
          "-rtl",
        );
        return ve(t, e) ? e : o;
      ...
      factory: (e) => {
        const t = Uh({
          ...
          a = q([
            e.icon.toArray(),
            e.level.toArray(),
            e.level.bind((e) => A.from(Qh[e])).toArray(),
          ]),
          i = Uh(
            Ph.sketch({
              dom: {
  ...
  const af = (e) => (t) => t.options.get(e),
    ...
    rb = (e) =>
      (e.options.get("toolbar_sticky") || e.inline) && !tb(e) && !nb(e),
  ...
  const mb = "tox-menu-nav__js",
    ...
    Nb = (e) =>
      pi(e.element, ".tox-menu__searcher").bind((t) =>
        e.getSystem().getByDom(t).toOptional(),
      ),
    Vb = Nb,
    zb = (e) => ({
          ...
          components: [
            {
              ...
              components: [
                Ah.parts.items({
                  preprocess:
                    "auto" !== e
                      ? Ub({ tag: "div", classes: ["tox-swatches__row"] }, e)
                      : w,
                }),
              ],
            },
          ...
          "searchable" !== r.menuType
            ...
            : ((e, t, o = !0) => {
                ...
                return {
                  dom: {
                    tag: "div",
                    classes: ["tox-menu", "tox-collection", Lb].concat(
                      1 === e
                        ? ["tox-collection--list"]
                        : ["tox-collection--grid"],
                    ),
    ...
    Bv = [
      Cr("predicate", T),
      kr("scope", "node", ["node", "editor"]),
      kr("position", "selection", ["node", "selection", "line"]),
    ],
    ...
    zv = Dn(
      [
        ...
        mr(
          "launch",
          Jn("type", { contextformbutton: Rv, contextformtogglebutton: Nv }),
        ),
      ].concat(Bv),
    ),
    ...
    Wv = Dn(Uv),
    jv = En(() =>
      jn("type", { cardimage: Pv, cardtext: Wv, cardcontainer: Gv }),
    ),
    Gv = Dn([
      Yb,
  ...
  const qv = Dn([Yb, mv, dr("items", jv), iv, wv].concat($v)),
    ...
    Jv = [
      fr("select"),
      Tr("initData", {}, [
        Or("allowCustomColors", !0),
        Sr("storageKey", "default"),
        br("colors", Nn()),
      ]),
    ].concat(Kv),
                  ...
                  ((o) => {
                    if (!t.isShowing()) {
                      ...
                      t.setTooltip(r),
                        Td(n, r),
                        e.onShow(o, r),
                        xd.position(n, r, { anchor: e.anchor(o) });
                    }
                  })(o);
                }, e.delay);
              }),
  ...
  const hy = (e, t) => {
    ...
    Oy = (e, t) =>
      Qs((o, n) => {
        wy(e, o)(e.onAction),
          e.triggersSubmenu ||
            t !== ub.CLOSE_ON_EXECUTE ||
            (o.getSystem().isConnected() && Fs(o, hs()), n.stop());
      }),
    Cy = {
    ...
    Ny = (e) => {
      const t = e
        .map((e) => ({ attributes: { title: Wh.translate(e) } }))
        .getOr({});
      ...
      "color" === e.presets
        ...
        : ((e, t, o, n) => {
            const r = { tag: "div", classes: [fb] },
              s = o
                ? e.iconContent
                    .map((e) => Zh(e, r, t.icons, n))
                    .orThunk(() => A.some({ dom: r }))
                : A.none(),
              a = e.checkMark,
    ...
    ox = (e) => {
      ...
      let s = e.saturation / 100,
        a = e.value / 100;
      if (((s = Yy(0, Ky(s, 1))), (a = Yy(0, Ky(a, 1))), 0 === s))
        return (t = o = n = Jy(255 * a)), ex(t, o, n, 1);
      const i = r / 60,
        l = a * s,
  ...
  const ew = Cl({ fields: Zx, name: "coupling", apis: Jx, state: Qx }),
    ...
    lw = x(
      Uu({
        ...
        overrides: x({
          dom: { tag: "div" },
          behaviours: kl([xd.config({ useFixed: E })]),
          ...
          e.bind((e) =>
            A.from(
              zh.sketch({
                ...
                onOpenSubmenu: (e, t, o) => {
                  const n = l().getOrDie();
                  xd.position(n, o, { anchor: { type: "submenu", item: t } }),
                    $d.decloak(r);
                },
                onRepositionMenu: (e, t, n) => {
                  const r = l().getOrDie();
    ...
    bw = () => [
      yr("sandboxClasses", []),
      fu("sandboxBehaviours", [ym, Al, $d, mu]),
    ],
    vw = x(
      [
        or("dom"),
        ...
        return {
          ...
          behaviours: hu(e.dropdownBehaviours, [
            ...
            Hp.config({
              ...
              onEscape: (e, t) =>
                xw.isOpen(e) ? (xw.close(e), A.some(!0)) : A.none(),
            }),
            eh.config({}),
          ]),
          events: dh(
  ...
  const Cw = (e, t, o, n, r) => {
      ...
      switch (e.type) {
        ...
        case "nestedmenuitem":
          return ((e) => qn("nestedmenuitem", ey, e))(e).fold(qb, (e) =>
            A.some(
              ((e, t, o, n = !0, r = !1) => {
                const s = r
                  ? ((a = o.icons), My("chevron-down", a, [vb]))
                  : ((e) => My("chevron-right", e, [vb]))(o.icons);
                var a;
                const i = Vy(
                  {
                    presets: "normal",
        ...
        case "separator":
          return ((e) => qn("separatormenuitem", Ov, e))(e).fold(qb, (e) =>
            A.some(Yx(e)),
          );
        case "fancymenuitem":
          return ((e) => qn("fancymenuitem", Zv, e))(e).fold(qb, (e) =>
            ((e, t) => be(Kx, e.fancytype).map((o) => o(e, t)))(e, o),
          );
        default:
    ...
    _w = (e, t, o, n, r, s, a) => {
      ...
      return we(
        H(e, (e) => {
          switch (e.type) {
            case "separator":
              return ((n = e), qn("Autocompleter.Separator", Ov, n)).fold(
                qb,
                (e) => A.some(Yx(e)),
              );
            case "cardmenuitem":
      ...
      const o = Er(!1),
        ...
        r = si(
          Hh.sketch({
            ...
            inlineBehaviours: kl([
              Kp("dismissAutocompleter", [Us(Os(), () => c())]),
            ]),
            lazySink: t.getSink,
          }),
        ),
              ...
              },
              {
                ...
                value: (r) => (
                  ...
                  t
                    ...
                    .map((t) =>
                      o.get() ? (r.prevent(), !1) : e.triggerEvent(gs(), r),
                    )
                ),
              },
            ]);
          ...
          o.triggerEvent("keydown", e)
            ...
            : o.stopBackspace &&
              ((e) =>
                ...
                !Iw(e.target, '[contenteditable="true"]'))(e) &&
              e.prevent();
        }),
        l = tc(e, "focusin", (e) => {
          ...
          return (
            ...
            i.isStopped()
              ...
              : rt(e.element).fold(
                  ...
                  (n) => (
                    s.logEventResponse(t, e.element, o.purpose), Hw.resume(n)
                  ),
                )
          );
        },
    ...
    Pw = (e, t, o, n, r, s) =>
      Lw(e, t, o, n, r, s).fold(E, (n) => Pw(e, t, o, n, r, s), T),
    Uw = (e, t, o, n, r) => {
      const s = zw(o, n);
    ...
    Gw = (e) => {
      const t = (t) => rt(e.element).fold(E, (e) => Ze(t, e)),
        ...
        r = Vw(e.element, {
          triggerEvent: (e, t) =>
            Si(e, t.target, (o) =>
              ((e, t, o, n) => Uw(e, t, o, o.target, n))(n, e, t, o),
            ),
        }),
        s = {
          debugInfo: x("real"),
        ...
        a = (e) => {
          e.connect(s),
            $e(e.element) ||
              (o.register(e),
              L(e.components(), a),
              s.triggerEvent(bs(), e.element, { target: e.element }));
        },
        i = (e) => {
  ...
  var Kw = Object.freeze({
      __proto__: null,
      exhibit: (e, t) =>
        Ea({ attributes: Dr([{ key: t.tabAttr, value: "true" }]) }),
    }),
            ...
            return fn(
              mO.sketch((o) => ({
                ...
                components: [
                  o.field(
                    "red",
                    Xw.sketch(s(tx, "red", h.label, h.description, 255)),
                  ),
                  o.field(
                    "green",
                    Xw.sketch(s(tx, "green", f.label, f.description, 255)),
                  ),
                  o.field(
                    "blue",
                    Xw.sketch(s(tx, "blue", b.label, b.description, 255)),
                  ),
                  o.field(
                    "hex",
                    Xw.sketch(s(Gy, "hex", v.label, v.description, "ffffff")),
                  ),
                  i.asSpec(),
                ],
                formBehaviours: kl([
  ...
  const DO = la("alloy-fake-before-tabstop"),
                ...
                Us(Rb, (e, t) => {
                  ((e, t) => {
                    ((e) =>
                      $d
                        .getState(e)
                        .bind(Wm.getHighlighted)
                        .bind(Wm.getHighlighted))(e).each((o) => {
                      ((e, t, o, n) => {
                        const r = { ...n, target: t };
                        e.getSystem().triggerEvent(o, t, r);
                      })(
    ...
    oC = (e, t) =>
      se(e, (e) => (QO(e) ? Oe(e.value === t, e) : oC(e.items, t))),
    nC = pm({
      name: "HtmlSelect",
      configFields: [
        or("options"),
        gu("selectBehaviours", [eh, mu]),
        yr("selectClasses", []),
        yr("selectAttributes", {}),
        ur("data"),
      ],
        ...
        overrides: (e) => ({
          fieldBehaviours: kl([
            Kp("coupled-input-behaviour", [
              Us(Zr(), (o) => {
                ((e, t, o) => em(e, t, o).bind(ym.getCurrent))(o, e, t).each(
                  (t) => {
                    em(o, e, "lock").each((n) => {
            ...
            store: {
              ...
              setValue: (t, o) => {
                ...
                ye(o, e.field1Name) && mu.setValue(n.field1(), o[e.field1Name]),
                  ye(o, e.field2Name) &&
                    mu.setValue(n.field2(), o[e.field2Name]);
              },
            },
          }),
        ]),
    ...
    vC = (e, t, o, n) => {
      o.setCollapsed(),
        Dt(e.element, gC(t), pC(t, e.element)),
        hC(e, t),
        fC(e, t),
        t.onStartShrink(e),
        t.onShrunk(e);
          ...
          n.setActive(r),
            ...
            o.shared.getSink().each((o) => {
              t()
                ...
                .each((t) => {
                  Dl(t.element),
                    Is(t, aS, { name: e.name, value: e.storage.get() });
                });
            });
        },
        r = (e) => (t) => {
  ...
  var zC = Object.freeze({
    ...
    events: (e, t) => {
      ...
      return Hs(
        [Us(e.event, o), Js(() => t.cancel())].concat(
          e.cancelEvent.map((e) => [Us(e, () => t.cancel())]).getOr([]),
        ),
      );
    },
  });
  ...
  const WC = Cl({ fields: UC, name: "streaming", active: zC, state: PC }),
            ...
            e.previewing.get()
              ? e.lazyTypeaheadComp.get().each((t) => {
                  ((e, t, o) => {
                    ...
                    () => {
                      e.model.selectsOver
                        ? (Wm.dehighlight(o, n), e.previewing.set(!0))
                        : e.previewing.set(!1);
                    },
                    (t) => {
            ...
            WC.config({
              ...
              onStream: (t, o) => {
                ...
                if (eh.isFocused(t) && $a(t.element).length >= e.minChars) {
                  const o = i(r).bind((e) =>
                    Wm.getHighlighted(e).map(mu.getValue),
                  );
                  e.previewing.set(!0);
                  const s = (t) => {
                    i(r).each((t) => {
                      o.fold(
                        ...
                        (e) => {
                          Wm.highlightBy(
                            t,
                            (t) => mu.getValue(t).value === e.value,
                          ),
                            Wm.getHighlighted(t).orThunk(
                              () => (Wm.highlightFirst(t), A.none()),
                            );
                        },
                      );
                    });
            ...
            Kp(
              ...
              [
                ...
                Us(qC(), (t, o) => {
                  ...
                  jC(e.model, t, o.event.item),
                    Fs(t, fs()),
                    e.onItemExecute(t, n, o.event.item, mu.getValue(t)),
                    $d.close(n),
                    $C(t);
                }),
              ].concat(
    ...
    QC = (e, t, o = [], n, r, s) => {
      const a = t.fold(
        ...
        i = {
          buttonBehaviours: kl(
            [
              vy(() => !e.enabled || s.isDisabled()),
              by(),
              Jw.config({}),
              Kp("button press", [Ps("click"), Ps("mousedown")]),
            ].concat(o),
          ),
          eventOrder: {
        ...
        return ((e, t) => {
          ...
          const s = A.from(e.icon)
            ...
            i = a.tooltip
              ...
              .getOr({}),
            l = t_(
              null !== (r = e.buttonType) && void 0 !== r ? r : "secondary",
            ),
            c = !!e.icon && !!e.text,
            d = {
              tag: "button",
                ...
                mu.config({
                  ...
                  onSetValue: (o, n) => {
                    ((o, n) => {
                      ...
                      "auto" === e.columns &&
                        oy(o, 5, "tox-collection__item").each(
                ...
                const r = ((e, t, o) => {
                    ...
                    return o.getLinkInformation().fold(
                      ...
                      (t) => {
                        const n = p_(
                          a,
                          ((e) => H(e, (e) => l_(e, e)))(o.getHistory(e)),
                        );
                        return "file" === e
                          ? ((r = [
                              n,
                              p_(a, d_(t)),
                              p_(a, q([m_(t), u_(t), g_(t)])),
                            ]),
                            j(
                              r,
                              (e, t) =>
                ...
                Kp("urlinput-events", [
                  Us(Zr(), (t) => {
                    const o = $a(t.element),
                      n = o.trim();
                    n !== o && qa(t.element, n),
                      "file" === e.filetype && Is(t, nS, { name: e.name });
                  }),
                  Us(Qr(), (t) => {
              ...
              Ys((r) => {
                o.getOpt(r).each((o) => {
                  (((e) => ve(e, "init"))(e)
                    ...
                    : AO.load(e.scriptId, e.scriptUrl).then((t) =>
    ...
    R_ = (e, t, o) =>
      zi(__(e, t), E_(e), o.insetNorth(), ji(), "north", Yi(e, { top: 2 }), O_),
    N_ = (e, t, o) =>
      zi(
        __(e, t),
        A_(e, t),
    ...
    z_ = (e, t, o) =>
      zi(C_(e), M_(e, t), o.insetWest(), $i(), "west", Yi(e, { left: 1 }), O_),
    H_ = (e) => {
      switch (e) {
        case "north":
          return R_;
    ...
    xT = (e) => {
      ...
      return U(
        ((e) => H(U(e, fT), bT))(t).concat(((e) => H(U(e, gT), vT))(t)),
        yT,
      );
    },
    ...
    OT = () => {
      ...
      try {
        ...
        if (e instanceof SyntaxError)
          return (
            console.log("Local storage " + wT + " was not valid JSON", e), {}
          );
        throw e;
      }
      return kT(t)
        ? t
        : (console.log("Local storage " + wT + " was not valid format", t), {});
    },
    CT = (e) => {
      const t = OT();
      return be(t, e).getOr([]);
    ...
    IT = x([
      ...
      or("makeItem"),
      yr("setupItem", b),
      fu("listBehaviours", [Xp]),
    ]),
    RT = Uu({
      name: "items",
      overrides: () => ({ behaviours: kl([Xp.config({})]) }),
    }),
    NT = x([RT]),
    VT = hm({
      name: x("CustomList")(),
      ...
      factory: (e, t, o, n) => {
        const r = e.shell
          ? { behaviours: [Xp.config({})], components: [] }
    ...
    sE = (e, t, o) => {
      ...
      return xe(Nt(n, "position"), "fixed")
        ...
        : ((e, t, o) => {
            ...
            return "top" === s.location || "bottom" === s.location
              ? (oE(e, n, t, o, s), rE(s))
              : A.none();
          })(n, t, o);
    },
  ...
  const vE = Cl({
    ...
    TE = (e, t) => {
      const o = Ql(),
        ...
        a = e.inline
          ? []
          : [Al.config({ channels: { [yE()]: { onReceive: OE } } })];
      return [
        eh.config({}),
        vE.config({
          contextual: {
  ...
  const AE = Dn(
      [Yb, nr("items", Fn([Rn([Jb, dr("items", Hn)]), Hn]))].concat(_v),
    ),
    ME = [
      pr("text"),
      pr("tooltip"),
    ...
    FE = Dn([
      ...
      nv,
      iv,
      kr("presets", "normal", ["normal", "color", "listpreview"]),
      yv(1),
      sv,
      av,
    ]);
  ...
  const RE = "container",
    ...
    $E = (e) =>
      ym
        .getCurrent(e)
        .bind((e) =>
          TC.isGrowing(e) || TC.hasGrown(e)
            ? ym
                .getCurrent(e)
                .bind((e) => G(LE.getSlotNames(e), (t) => LE.isShowing(e, t)))
            : A.none(),
        ),
    qE = la("FixSizeEvent"),
    XE = la("AutoSizeEvent");
  ...
  const JE = Cl({
    ...
    sA = (e, t, o) => {
      ...
      0 === l.extra.length
        ? (Xp.remove(r, s), o([]))
        : (rA(r, l.within), o(l.extra)),
        Ht(r.element, "visibility"),
        Lt(r.element),
        i.each(eh.focus);
    },
    aA = x([
      gu("splitToolbarBehaviours", [ew]),
      er("builtGroups", () => Er([])),
    ]),
    iA = x(
      [
                        ...
                        Al.config({
                          channels: {
                            ...
                            ...Qd({
                              doReposition: () => {
                                $d.getState(
                                  ew.getCoupled(e, "toolbarSandbox"),
                                ).each((n) => {
                                  pA(e, n, o, t.layouts);
                                });
                              },
    ...
    yA = hm({
      ...
      factory: (e, t, o, n) => ({
        ...
        dom: e.dom,
        components: t,
        behaviours: hu(e.tgroupBehaviours, [
          Hp.config({ mode: "flow", selector: e.markers.itemSelector }),
        ]),
        ...
        return {
          ...
          behaviours: hu(e.splitToolbarBehaviours, [
            ew.config({
              others: {
                overflowGroup: () =>
                  yA.sketch({ ...n["overflow-group"](), items: [r.asSpec()] }),
              },
            }),
          ]),
          apis: {
        ...
        overrides: (e) => ({
          toolbarBehaviours: kl([
            ...
            Hp.config({
              mode: "acyclic",
              onEscape: (t) => (
                em(t, e, "overflow-button").each(eh.focus), A.some(!0)
              ),
            }),
          ]),
        }),
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          apis: {
            ...
            toggle: (t) => CA(t, e),
            isOpen: (t) =>
              ((e, t) => em(e, t, "overflow").map(TC.hasGrown).getOr(!1))(t, e),
          },
          domModification: { attributes: { role: "group" } },
        };
      },
    ...
    FA = (e) => {
      ...
      return TA.sketch({
        ...
        onOpened: (t) => {
          t.getSystem().broadcastOn([yE()], { type: "opened" }),
            e.onToggled(t, !0);
        },
        onClosed: (t) => {
          t.getSystem().broadcastOn([yE()], { type: "closed" }),
            e.onToggled(t, !1);
        },
      });
    },
      ...
      return LT.sketch({
        ...
        dom: {
          ...
          classes: ["tox-toolbar"].concat(
            e.type === tf.scrolling ? ["tox-toolbar--scrolling"] : [],
          ),
        },
    ...
    RA = [
      ...
      dv,
      pr("tooltip"),
      kr("buttonType", "secondary", ["primary", "secondary"]),
      Or("borderless", !1),
      ir("onAction"),
    ],
    NA = {
      ...
      pe(t, (t, n) => {
        ...
        return e.slot(
          ...
          jA.sketch({
            ...
            components: [
              ...(r.buttons.length > 0
                ? [jA.parts.header({ buttons: r.buttons, providers: o })]
                : []),
              jA.parts.pane({}),
            ],
          }),
  ...
  const YA = FT.optional({
      ...
      factory: {
        sketch: (e) =>
          VT.sketch({
            ...
            dom: e.dom,
            listBehaviours: kl([
              Hp.config({ mode: "acyclic", selector: ".tox-toolbar" }),
            ]),
            makeItem: () =>
              IA({
                type: e.type,
    ...
    ZA = FT.optional({
      factory: {
        sketch: (e) => {
          const t = ((e) =>
            e.type === tf.sliding ? FA : e.type === tf.floating ? BA : IA)(e);
          return t({
            type: e.type,
            uid: e.uid,
            onEscape: () => (e.onEscape(), A.some(!0)),
      ...
      factory: {
        sketch: (e) => ({
          ...
          behaviours: kl([
            Xp.config({}),
            JE.config({ focus: !1 }),
            ym.config({ find: (e) => oe(e.components()) }),
          ]),
          components: [],
        }),
      },
  ...
  var aM = hm({
    ...
    factory: (e, t, o) => {
      ...
      const r = {
        ...
        whichView: (t) =>
          BT.getPart(t, e, "viewWrapper").bind(KA.whichView).getOrNull(),
        hideMainView: (t) => {
  ...
  const iM = {
    ...
    gM = (e, t) => {
      ...
      return (
        (o = Ve(e.getElement())),
        bt(o).isSome()
          ? uM(e, t + "/skin.shadowdom.min.css", nf.DOM.styleSheetLoader)
          : Promise.resolve()
      );
    },
    pM = (e, t) => {
    ...
    SM = (e, t, o) => {
      const n = o.dataset,
        r =
          "basic" === n.type
            ? () => H(n.data, (e) => sT(e, o.isSelectedFor, o.getPreviewFor))
            : n.getData;
  ...
  const CM = (e, t, o) => {
      const n =
        ((r = ((e, t) =>
          t === OM.SemiColon ? e.replace(/;$/, "").split(";") : e.split(" "))(
          e.options.get(t),
          o,
        )),
        H(r, (e) => {
    ...
    TM = (e) => {
      ...
      return {
        ...
        onAction: (t) => () =>
          G(_M, (e) => e.format === t.format).each((t) =>
            e.execCommand(t.command),
          ),
        updateText: (t) => {
          const o = G(_M, (t) => e.formatter.match(t.format)).fold(
            x("left"),
    ...
    EM = (e, t) => {
      ...
      return A.from(e.formatter.closest(n))
        ...
        .orThunk(() =>
          Oe(e.formatter.match("p"), { title: "Paragraph", format: "p" }),
        );
    },
    AM = (e) => {
      const t = "Paragraph",
    ...
    RM = (e, t) =>
      A.from(IM.exec(e)).bind((e) => {
        const o = Number(e[1]),
          n = e[2];
        return ((e, t) => N(t, (t) => N(FM[t], (t) => e === t)))(n, t)
    ...
    jM = Lu({
      ...
      overrides: (e) => ({
        ...
        buttonBehaviours: kl([
          lh.config({ toggleOnExecute: !1, toggleClass: e.toggleClass }),
        ]),
      }),
    }),
    GM = Lu({
    ...
    QM = (e, t, o) => {
      ...
      return Ph.sketch({
        ...
        buttonBehaviours: {
          ...
          [HO]:
            null === (n = s.buttonBehaviours) || void 0 === n ? void 0 : n[HO],
        },
      });
      var a;
    },
      ...
      QM(
        e,
        {
          toolbarButtonBehaviours:
            o.length > 0 ? [Kp("toolbarButtonWith", o)] : [],
          getApi: XM,
          onSetup: e.onSetup,
        },
        t,
        ...
        (e, t) =>
          ((e, t) => {
            const o = (e) => ({
                ...
                setEnabled: (t) => Fm.set(e, !t),
                setIconFill: (t, o) => {
                  pi(e.element, `svg path[id="${t}"], rect[id="${t}"]`).each(
                    (e) => {
                      kt(e, "fill", o);
                    },
                  );
                ...
                isActive: () =>
                  pi(e.element, "span").exists((t) =>
                    e.getSystem().getByDom(t).exists(lh.isOn),
                  ),
                setText: (t) =>
                  pi(e.element, "span").each((o) =>
                    e
          ...
          const r = vM(e, "NodeChange", (e) => {
            ...
            g = (e, o, n, r) => {
              ...
              return Ph.sketch({
                dom: {
                  tag: "button",
                  attributes: { title: s, "aria-label": s },
                  classes: r.concat(o),
                },
                ...
                buttonBehaviours: kl([
                  Kp(a, [
                    Us(Yr(), (t, o) => {
                      (o.event.raw.keyCode !== NM.space() &&
                        o.event.raw.keyCode !== NM.enter()) ||
                        e(!1);
                    }),
                    Us(es(), i),
                    Us(Pr(), i),
          ...
          ((e) => {
            ...
            return {
              ...
              getNewValue: (o, n) => {
                ...
                const r = RM(o, ["unsupportedLength", "empty"]).or(
                    RM(t(), ["unsupportedLength", "empty"]),
                  ),
  ...
  var uD = Object.freeze({
    ...
    render: async (e, t, o, n, r) => {
      ...
      Fd(d, s.mothership),
        ((e, t, o) => {
          sb(e) && Fd(o.mainUi.mothership.element, o.popupUi.mothership),
            Bd(t, o.dialogUi.mothership);
        })(e, u, t),
        e.on("PostRender", () => {
              ...
              const s = e.getDoc().documentElement,
                ...
                l = () => {
                  ...
                  (t.left === r.innerWidth && t.top === r.innerHeight) ||
                    (a.set($t(r.innerWidth, r.innerHeight)), lx(e));
                },
                c = () => {
                  const t = e.getDoc().documentElement,
                    o = i.get();
                  (o.left === t.offsetWidth && o.top === t.offsetHeight) ||
                    (i.set($t(t.offsetWidth, t.offsetHeight)), lx(e));
                },
                d = (t) => {
                  ((e, t) => {
      ...
      (g !== tf.sliding && g !== tf.floating) ||
        e.on("ResizeWindow ResizeEditor ResizeContent", () => {
          ...
          o !== i.get() &&
            (aM.refreshToolbar(t.mainUi.outerContainer), i.set(o));
        });
      const p = {
        setEnabled: (e) => {
          hy(t, !e);
        ...
        y = (o) => {
          ...
          const n = l
            ...
            : (() => {
                if (l) return A.none();
                if (
                  Xt(s.outerContainer.element).left +
                    Zt(s.outerContainer.element) >=
                ...
                switch (Of(e)) {
                  case fD.auto:
                    ...
                    if (a.y > r) return "top";
                    {
                      ...
                      return a.bottom < o - r || en().bottom < a.bottom - r
                        ? "bottom"
                        : "top";
                    }
                  case fD.bottom:
      ...
      return {
        ...
        show: () => {
          h.set(!0),
            ...
            w(),
            sb(e)
              ? y((e) => (vE.isDocked(e) ? vE.reset(e) : vE.refresh(e)))
              : y(vE.refresh);
        },
        hide: () => {
          h.set(!1),
  ...
  var xD = Object.freeze({
    ...
    render: async (e, t, o, n, r) => {
      ...
      const d = () => {
        ...
        const r = ob(e);
        sb(e)
          ? (Fd(i, s.mothership), Fd(i, t.popupUi.mothership))
          : Bd(r, s.mothership),
  ...
  const wD = "contexttoolbar-hide",
    ...
    DD = (e, t, o, n) => {
      const r = (t) => (n, r, s, a, i) => ({
          ...MD(e, a, t, o, i)({ ...n, y: i.y, height: i.height }, r, s, a, i),
          alwaysFit: !0,
        }),
        s = (e) => (AD(n) ? [r(e)] : []);
      return t
      ...
      const r = n.backstage,
                  ...
                  Us(RD, (e, o) => {
                    ne(t.get()).each((o) => {
                      t.set(t.get().slice(0, t.get().length - 1)),
                        Is(e, ND, { contents: ai(o.bar), focus: o.focus });
                    });
                  }),
                ]),
                Hp.config({
        ...
        h = () => {
          if (Hh.isOpen(d)) {
            const e = d.element;
            Ht(e, "display"),
              g() ? Dt(e, "display", "none") : (l.set(0), Hh.reposition(d));
          }
        },
        f = (t) => ({
        ...
        x = (t, n) => {
          ...
          Ht(b, "display"),
            ((e) => xe(Se(e, i.get(), Ze), !0))(n) ||
              (Pa(b, zD), xd.reset(o, d)),
            Hh.showWithinBounds(
              d,
              f(r),
              { anchor: h, transition: { classes: [zD], mode: "placement" } },
              () => A.some(u()),
            ),
        ...
        e.on("remove", p),
          ...
          e.on("contexttoolbar-show", (t) => {
            ...
            be(o.lookupTable, t.toolbarKey).each((o) => {
              x([o], Oe(t.target !== e, t.target)),
                Hh.getContent(d).each(Hp.focusIn);
            });
          }),
          e.on("focusout", (t) => {
            Lh.setEditorTimeout(
          ...
          ((e, t, o, n, r, s, a) => {
            ...
            ZO(o, ub.CLOSE_ON_EXECUTE, n, {
              ...
              Hh.showMenuWithinBounds(
                ...
                { anchor: i },
                {
                  menu: { markers: Cb("normal"), highlightOnOpen: l },
                  data: o,
                  type: "horizontal",
                },
                () =>
    ...
    hB = (e, t, o) => {
      const n = Do().deviceType.isTouch,
        ...
        i = (t) => {
          if (
            (JD(e) && t.preventDefault(),
            ((e, t) => t.ctrlKey && !JD(e))(e, t) ||
              ((e) => 0 === QD(e).length)(e))
          )
            return;
          const a = ((e, t) => {
    ...
    MB = (e, t, o, n) =>
      se(e, (e) => {
        ...
        return s
          ? A.some({ output: OB(e.output, t, o, n), extra: e.extra })
          : A.none();
      }),
    DB = (e, t, o, n, r) => {
  ...
  const HB = [
    ...
    LB = (e) => {
      ...
      t.isSome() && o.isSome() && n.isSome()
        ? A.some(
            ((e, t, o) =>
              ("fixed" === o ? TB : CB)(parseInt(e, 10), parseInt(t, 10)))(
              t.getOrDie(),
              o.getOrDie(),
              n.getOrDie(),
            ),
  ...
  const lF = (e, t, o) => {
            ...
            return (
              ...
              e.hasPlugin("wordcount") &&
                o.push(
                  ((e, t) => {
                    const o = (e, o, n) =>
                      Xp.set(e, [ti(t.translate(["{0} " + n, o[n]]))]);
                    return Ph.sketch({
                      dom: {
                        tag: "button",
                      ...
                      buttonBehaviours: kl([
                        ...
                        Kp("wordcount-events", [
                          Qs((e) => {
                            ...
                            mu.setValue(e, { mode: n, count: t.count }),
                              o(e, t.count, n);
                          }),
                          Ys((t) => {
                            e.on("wordCountUpdate", (e) => {
                              const { mode: n } = mu.getValue(t);
                              mu.setValue(t, { mode: n, count: e.wordCount }),
                                o(t, e.wordCount, n);
                            });
                          }),
                        ]),
      ...
      const o = e.inline,
        ...
        v = () => {
          const t = (() => {
            ...
            i =
              Hf(e) && !o ? A.some(dF(e, b.popup.shared.providers)) : A.none(),
            l = q([d ? [] : [t], o ? [] : [n], d ? [t] : []]),
            ...
            a = (() => {
              const t = ob(e),
                ...
                n = {
                  ...
                  behaviours: kl([
                    xd.config({ useFixed: () => r.isDocked(g) }),
                  ]),
                },
                s = {
            ...
            (v = o.outerContainer),
              ...
              e.addCommand("ToggleToolbarDrawer", (e, t) => {
                (null == t ? void 0 : t.skipFocus)
                  ? aM.toggleToolbarDrawerWithoutFocusing(v)
                  : aM.toggleToolbarDrawer(v);
              }),
              e.addQueryStateHandler("ToggleToolbarDrawer", () =>
                aM.isToolbarDrawerToggled(v),
              ),
              ((e, t, o) => {
                const n = (e, n) => {
                    L([t, ...o], (t) => {
    ...
    yF = [
      kv("button"),
      dv,
      kr("align", "end", ["start", "end"]),
      vv,
      bv,
      hr("buttonType", ["primary", "secondary"]),
    ],
    xF = [...yF, Qb],
    ...
    CF = [
      Yb,
      Qb,
      ar("level", ["info", "warn", "error", "success"]),
      tv,
      yr("url", ""),
    ],
    _F = Dn(CF),
    TF = [
      ...
      dv,
      fv,
      hr("buttonType", ["primary", "secondary", "toolbar"]),
      vv,
    ],
    EF = Dn(TF),
    AF = [Yb, Jb],
    ...
    UF = AF.concat([
      ...
      sr("scriptId"),
      sr("scriptUrl"),
      xr("settings", void 0, Wn),
    ]),
    WF = AF.concat([Sr("tag", "textarea"), ir("init")]),
    jF = Gn((e) =>
      qn("customeditor.old", Mn(WF), e).orThunk(() =>
        qn("customeditor.new", Mn(UF), e),
      ),
    ),
    GF = Hn,
    $F = Dn(MF),
    ...
    KF = [
      Yb,
      sr("html"),
      kr("presets", "presentation", ["presentation", "document"]),
    ],
    YF = Dn(KF),
          ...
          apis: {
            ...
            showTab: (e, t) => {
              r(e, (e) => {
                ...
                return G(o, (e) => mu.getValue(e) === t).filter(
                  (t) => !Wm.isHighlighted(e, t),
                );
              });
            },
          },
  ...
  var iN = LR([
    ...
    TN = function (e, t) {
      if ("object" !== AR(e) || "function" != typeof e.createPolicy)
        return null;
      var o = null,
    ...
    EN = (function e() {
      ...
      var D,
        ...
        ke = function (e) {
          (xe && xe === e) ||
            ...
            (ue =
              "ADD_URI_SAFE_ATTR" in e ? rN(sN(me), e.ADD_URI_SAFE_ATTR) : me),
            (ce =
              "ADD_DATA_URI_TAGS" in e ? rN(sN(de), e.ADD_DATA_URI_TAGS) : de),
            ...
            e.FORBID_CONTENTS &&
              (ie === le && (ie = sN(ie)), rN(ie, e.FORBID_CONTENTS)),
            re && (L["#text"] = !0),
      ...
      var Ae = function (e) {
        ...
        Ve = function (e) {
          ...
          if (!L[n] || G[n]) {
            if (!G[n] && He(n)) {
              if (j.tagNameCheck instanceof RegExp && tN(j.tagNameCheck, n))
                return !1;
          ...
          return e instanceof l && !Ae(e)
            ...
            : ("noscript" !== n && "noembed" !== n) ||
              !tN(/<\/no(script|embed)/i, e.innerHTML)
            ? (Y &&
                3 === e.nodeType &&
                ((t = e.textContent),
                (t = ZR(t, F, " ")),
                (t = ZR(t, I, " ")),
                e.textContent !== t &&
                  (KR(o.removed, { element: e.cloneNode() }),
                  (e.textContent = t))),
  ...
  const AN = (e) => EN().sanitize(e),
    ...
    IN = (e, t) =>
      fF.parts.body({
        ...
        components: [
          {
            dom: { tag: "div", classes: ["tox-dialog__body-content"] },
            components: [{ dom: ZE(`<p>${AN(t.translate(e))}</p>`) }],
          },
        ],
      }),
    RN = (e) =>
      ...
      return fF.sketch({
        ...
        parts: {
          blocker: {
            ...
            components: [
              { dom: { tag: "div", classes: MN ? [n, n + "--opaque"] : [n] } },
            ],
          },
        },
        dragBlockClass: o,
    ...
    zN = (e) =>
      Ph.sketch({
        ...
        buttonBehaviours: kl([Jw.config({})]),
        components: [
          Zh("close", { tag: "div", classes: ["tox-icon"] }, e.icons),
        ],
        action: (e) => {
          Fs(e, sS);
        },
  ...
  const tV = [
    ...
    nV = (e, t, o, n) => {
      const r = la("dialog"),
        ...
        c = e.buttons.bind((e) =>
          0 === e.length ? A.none() : A.some(JN({ buttons: e }, r, n)),
        ),
        u = ((e, t) => {
          const o = (t, o) =>
              Us(t, (t, r) => {
            ...
            const c = Xn(qn("data", l, i)),
                ...
                const r = la("dialog"),
                  ...
                  g = XN(
                    () => f,
                    {
                      onBlock: (e) => {
                        JE.block(h, (t, n) =>
                          UN(e.message, n, o.shared.providers),
                        );
                      },
                      onUnblock: () => {
                        JE.unblock(h);
              ...
              p = si(
                Hh.sketch({
                  ...
                  isExtraPart: (e, t) =>
                    ((e) =>
                      Iw(e, ".tox-alert-dialog") ||
                      Iw(e, ".tox-confirm-dialog"))(t),
                }),
              );
            return (
              d.set(p),
