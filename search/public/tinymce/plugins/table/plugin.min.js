...
!(function () {
      ...
      ((e, t) => {
        ...
        return "border-box" === t
          ...
          : ((e, t, o, l) =>
              t -
              nt(e, "padding-left", 0) -
              nt(e, "padding-right", 0) -
              nt(e, "border-left-width", 0) -
              nt(e, "border-right-width", 0))(e, l);
      })(e, "content-box");
  ...
  const jt = (e, t, o, l) => {
    ...
    Yt = (e, t) => {
      ...
      return Oe(o, l, (e, o) =>
        k(o, (o) => I(Ut(o.dom.cells), (o) => "1" === Te(o, t) || $(o, e))),
      ).getOr([]);
    },
    Zt = [
      { text: "None", value: "" },
    ...
    fo = (e) =>
      F(e, (e) =>
        po(e) ? [{ ...e, menu: fo(e.menu) }] : Me(e.value) ? [e] : [],
      ),
      ...
      const o = [
        {
          ...
          type: "listbox",
          label: "Border style",
          items: [{ text: "Select...", value: "" }].concat(bo(bt(e))),
        },
    ...
    Mo = (e, t) => Io(e, t, f),
    No = (e, t) =>
      q(t, (t) => ((e, t) => Do(e, t).exists((e) => !e.isLocked))(e, t)),
    ...
    $o = (e) => {
      ...
      const o = ((e, t) => {
        ...
        l = {
          type: "tabpanel",
          tabs: [
            { title: "General", name: "general", items: To(e) },
            xo(e, "cell"),
          ],
        },
        n = {
          type: "panel",
          items: [{ type: "grid", columns: 2, items: To(e) }],
        };
    ...
    Jo = (e) => {
      ...
      const o = N(t, (t) =>
        ...
        n = {
          type: "tabpanel",
          tabs: [
            { title: "General", name: "general", items: Go(e) },
            xo(e, "row"),
          ],
        },
        r = {
          type: "panel",
          items: [{ type: "grid", columns: 2, items: Go(e) }],
        };
      e.windowManager.open({
          ...
          if (T(s) > 0) {
            ((e, t, o) => {
              ...
              if (
                ...
                St(e)
                  ? ((r["border-width"] = fe(o.border)),
                    (r["border-spacing"] = fe(o.cellspacing)))
                  : ((n.border = o.border),
                ...
                for (let n = 0; n < t.children.length; n++)
                  Xo(l, t.children[n], {
                    ...
                    ft(e) &&
                      Xo(l, t.children[n], { "border-color": o.bordercolor });
              if (ft(e)) {
                const e = o;
              ...
              (n.style = l.serializeStyle({ ...Dt(e), ...r })),
                l.setAttribs(t, { ...It(e), ...n });
            })(e, t, r);
        ...
        a = () =>
          Jt(ye(e), he(e)).bind((t) => {
            return (
              (o = Oe(
                ze(t),
                Jt(((e) => V.fromDom(e.selection.getEnd()))(e), he(e)).bind(ze),
                (o, l) =>
                  $(o, l)
                    ? n(t)
                      ? y.some(
      ...
      return (
        e.on("NodeChange ExecCommand TableSelectorChange", c),
        {
          ...
          onSetupTableWithCaption: (t) =>
            d(t, h, (t) =>
              ze(t.element, he(e)).exists((e) => de(e, "caption").isSome()),
            ),
        ...
        0 !== u.length &&
          ...
          e.queryCommandSupported("mceTableApplyCellStyle") &&
            (e.ui.registry.addNestedMenuItem("tablecellvalign", {
              ...
              text: "Vertical align",
              getSubmenuItems: () =>
                go(e, Zt, "tablecellverticalalign", ho(e, "vertical-align")),
              onSetup: t.onSetupCellOrRow,
            }),
            e.ui.registry.addNestedMenuItem("tablecellborderwidth", {
              ...
              text: "Border width",
              getSubmenuItems: () =>
                go(e, pt(e), "tablecellborderwidth", ho(e, "border-width")),
              onSetup: t.onSetupCellOrRow,
            }),
            e.ui.registry.addNestedMenuItem("tablecellborderstyle", {
              ...
              text: "Border style",
              getSubmenuItems: () =>
                go(e, bt(e), "tablecellborderstyle", ho(e, "border-style")),
              onSetup: t.onSetupCellOrRow,
            }),
