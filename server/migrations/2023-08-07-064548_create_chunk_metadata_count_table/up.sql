...
INSERT INTO chunk_metadata_count (total_rows)
VALUES ((SELECT COUNT(*) FROM chunk_metadata));
...
ON chunk_metadata
FOR EACH ROW
EXECUTE FUNCTION update_chunk_metadata_count();
