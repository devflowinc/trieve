...
UPDATE files SET size_bytes = size * 1048576;
...
UPDATE organization_usage_counts SET file_storage_bytes = file_storage * 1048576;
...
UPDATE stripe_plans SET file_storage_bytes = file_storage * 1048576;
