...
DROP TRIGGER IF EXISTS update_chunk_metadata_counts_trigger_insert ON chunk_metadata;
DROP TRIGGER IF EXISTS update_chunk_metadata_counts_trigger_delete ON chunk_metadata;

DROP FUNCTION IF EXISTS update_chunk_metadata_count_insert();
DROP FUNCTION IF EXISTS update_chunk_metadata_count_delete();
