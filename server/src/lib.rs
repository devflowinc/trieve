...
#[openapi(
    ...
    components(
        schemas(
            ...
            data::models::SearchChunkQueryIDsResponseBody,
            data::models::ScoreIDs,
            data::models::SlimChunkMetadata,
            data::models::SearchGroupIDsResult,
            data::models::SearchOverGroupsIDsResponseBody,
            data::models::GroupIDsDTO,
