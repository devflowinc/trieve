...
summary: >-
  Guide on how we were able to stream LLM assistant completions in real time
  using Actix-Web.
author: Denzell Ford
createdAt: 2024-08-08T18:54:00.000Z
lastUpdatedAt: 2024-08-08T18:54:00.000Z
isDraft: false
categories:
  - explainers
  - tutorials
coverImage: /src/assets/images/blog-posts/open_ai_streaming/coverImage.jpeg
---
...
mpsc\_channels can't be sent across threads, we instead used a different crate [`crossbeam-channel`](https://docs.rs/crossbeam-channel/latest/crossbeam_channel/).
...
GITHUB: [https://github.com/devflowinc/trieve](https://github.com/devflowinc/trieve)
