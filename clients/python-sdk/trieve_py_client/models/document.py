...
class Document(BaseModel):
    ...
    Document
    """ # noqa: E501
    extract: Optional[StrictStr] = None
    html: Optional[StrictStr] = None
    links: Optional[List[StrictStr]] = None
    markdown: Optional[StrictStr] = None
    metadata: Metadata
    raw_html: Optional[StrictStr] = Field(default=None, alias="rawHtml")
    screenshot: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["extract", "html", "links", "markdown", "metadata", "rawHtml", "screenshot"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if extract (nullable) is None
        # and model_fields_set contains the field
        if self.extract is None and "extract" in self.model_fields_set:
            _dict['extract'] = None
