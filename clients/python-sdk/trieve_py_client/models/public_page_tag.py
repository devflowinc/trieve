...
class PublicPageTag(BaseModel):
    ...
    tag: StrictStr
    __properties: ClassVar[List[str]] = ["iconClassName", "label", "selected", "tag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if icon_class_name (nullable) is None
        # and model_fields_set contains the field
        if self.icon_class_name is None and "icon_class_name" in self.model_fields_set:
            _dict['iconClassName'] = None
