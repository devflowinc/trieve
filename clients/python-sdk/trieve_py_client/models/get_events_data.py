...
class GetEventsData(BaseModel):
    ...
    GetEventsData
    """ # noqa: E501
    event_types: Optional[List[EventTypeRequest]] = Field(default=None, description="The types of events to get. Any combination of file_uploaded, chunk_uploaded, chunk_action_failed, chunk_updated, or qdrant_index_failed. Leave undefined to get all events.")
