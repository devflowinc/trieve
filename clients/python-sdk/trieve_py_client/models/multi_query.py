...
class MultiQuery(BaseModel):
    ...
    """ # noqa: E501
    query: StrictStr = Field(description="Query to embed for the final weighted sum vector.")
    weight: Union[StrictFloat, StrictInt] = Field(description="Float value which is applies as a multiplier to the query vector when summing.")
    __properties: ClassVar[List[str]] = ["query", "weight"]
