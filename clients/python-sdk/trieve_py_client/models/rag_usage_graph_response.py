...
class RAGUsageGraphResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["usage_points"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "usage_points": [UsageGraphPoint.from_dict(_item) for _item in obj["usage_points"]] if obj.get("usage_points") is not None else None
        })
        return _obj
