...
class RecommendationCTRMetrics1(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['recommendation_ctr_metrics']):
            raise ValueError("must be one of enum values ('recommendation_ctr_metrics')")
        return value
