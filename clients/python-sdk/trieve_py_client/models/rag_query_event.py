...
class RagQueryEvent(BaseModel):
    ...
    detected_hallucinations: List[StrictStr]
    hallucination_score: Union[StrictFloat, StrictInt]
    id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["created_at", "dataset_id", "detected_hallucinations", "hallucination_score", "id", "llm_response", "query_rating", "rag_type", "results", "search_id", "top_score", "user_id", "user_message"]
