...
class ContextOptions(BaseModel):
    ...
    """ # noqa: E501
    include_links: Optional[StrictBool] = Field(default=None, description="Include links in the context. If not specified, this defaults to false.")
    __properties: ClassVar[List[str]] = ["include_links"]
