...
class AddChunkToGroupReqPayload(BaseModel):
    ...
    chunk_tracking_id: Optional[StrictStr] = Field(default=None, description="Tracking Id of the chunk to make a member of the group.")
    __properties: ClassVar[List[str]] = ["chunk_id", "chunk_tracking_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if chunk_tracking_id (nullable) is None
        # and model_fields_set contains the field
        if self.chunk_tracking_id is None and "chunk_tracking_id" in self.model_fields_set:
            _dict['chunk_tracking_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chunk_tracking_id": obj.get("chunk_tracking_id")
        })
        return _obj
