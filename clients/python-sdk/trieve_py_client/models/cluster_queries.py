...
class ClusterQueries(BaseModel):
    """
    ClusterQueries
    """ # noqa: E501
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["cluster_id", "page", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['cluster_queries']):
            raise ValueError("must be one of enum values ('cluster_queries')")
        return value
