...
class GetGroupsForChunksReqPayload(BaseModel):
    ...
    chunk_tracking_ids: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["chunk_ids", "chunk_tracking_ids"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if chunk_tracking_ids (nullable) is None
        # and model_fields_set contains the field
        if self.chunk_tracking_ids is None and "chunk_tracking_ids" in self.model_fields_set:
            _dict['chunk_tracking_ids'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chunk_tracking_ids": obj.get("chunk_tracking_ids")
        })
        return _obj
