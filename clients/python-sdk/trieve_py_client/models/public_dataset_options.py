...
class PublicDatasetOptions(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["enabled", "extra_params"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of extra_params
        if self.extra_params:
            _dict['extra_params'] = self.extra_params.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "extra_params": PublicPageParameters.from_dict(obj["extra_params"]) if obj.get("extra_params") is not None else None
        })
        return _obj
