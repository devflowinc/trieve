...
class RecommendationsWithClicksCTRResponse(BaseModel):
    ...
    results: List[Any]
    __properties: ClassVar[List[str]] = ["clicked_chunk", "created_at", "negative_ids", "negative_tracking_ids", "positive_ids", "positive_tracking_ids", "request_id", "results"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of clicked_chunk
        if self.clicked_chunk:
            _dict['clicked_chunk'] = self.clicked_chunk.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "clicked_chunk": ChunkMetadataWithPosition.from_dict(obj["clicked_chunk"]) if obj.get("clicked_chunk") is not None else None,
