...
class RecommendationsWithoutClicks(BaseModel):
    """
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["filter", "page", "type"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['recommendations_without_clicks']):
            raise ValueError("must be one of enum values ('recommendations_without_clicks')")
        return value
