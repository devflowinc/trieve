...
class EventTypesOneOf4(BaseModel):
    """
    EventTypesOneOf4
    """ # noqa: E501
    ...
    items: Dict[str, StrictStr] = Field(description="The filter items that were clicked in a hashmap ie. {filter_name: filter_value} where filter_name is filter_type::field_name")
    ...
    __properties: ClassVar[List[str]] = ["event_name", "event_type", "is_conversion", "items", "request_id", "user_id"]

    @field_validator('event_type')
    def event_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['filter_clicked']):
            raise ValueError("must be one of enum values ('filter_clicked')")
        return value
