...
class SearchChunksReqPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["content_only", "filters", "get_total_pages", "highlight_options", "page", "page_size", "query", "remove_stop_words", "score_threshold", "scoring_options", "search_type", "slim_chunks", "sort_options", "typo_options", "use_quote_negated_terms", "user_id"]
