...
class GetAllTagsReqPayload(BaseModel):
    ...
    """ # noqa: E501
    page: Optional[StrictInt] = Field(default=None, description="Page number to return, 1-indexed. Default is 1.")
    page_size: Optional[StrictInt] = Field(default=None, description="Number of items to return per page. Default is 20.")
