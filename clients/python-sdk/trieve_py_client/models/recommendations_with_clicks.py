...
class RecommendationsWithClicks(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['recommendations_with_clicks']):
            raise ValueError("must be one of enum values ('recommendations_with_clicks')")
        return value
