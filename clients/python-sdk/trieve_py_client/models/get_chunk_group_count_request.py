...
class GetChunkGroupCountRequest(BaseModel):
    ...
    """ # noqa: E501
    group_id: Optional[StrictStr] = Field(default=None, description="The Id of the group to get the count for, is not required if group_tracking_id is provided.")
    group_tracking_id: Optional[StrictStr] = Field(default=None, description="The tracking id of the group to get the count for, is not required if group_id is provided.")
    __properties: ClassVar[List[str]] = ["group_id", "group_tracking_id"]
