...
class GetEventsRequestBody(BaseModel):
    ...
    page: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, description="Page of results to return")
    __properties: ClassVar[List[str]] = ["filter", "page"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filter": EventAnalyticsFilter.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "page": obj.get("page")
        })
        return _obj
