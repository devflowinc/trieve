...
class QdrantChunkMetadata(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["chunk_html", "dataset_id", "group_ids", "image_urls", "link", "location", "metadata", "num_value", "qdrant_point_id", "tag_set", "time_stamp", "tracking_id", "weight"]
