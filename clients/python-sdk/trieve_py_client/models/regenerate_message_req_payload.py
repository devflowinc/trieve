...
class RegenerateMessageReqPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["concat_user_messages_query", "filters", "highlight_options", "llm_options", "page_size", "score_threshold", "search_query", "search_type", "topic_id", "user_id"]
