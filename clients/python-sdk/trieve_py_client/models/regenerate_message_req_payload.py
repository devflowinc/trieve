...
class RegenerateMessageReqPayload(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["concat_user_messages_query", "context_options", "filters", "highlight_options", "llm_options", "page_size", "score_threshold", "search_query", "search_type", "topic_id", "use_group_search", "user_id"]
