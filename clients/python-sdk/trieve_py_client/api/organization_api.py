...
class OrganizationApi:
    ...
    def create_organization(
        self,
        create_organization_req_payload: Annotated[CreateOrganizationReqPayload, Field(description="The organization data that you want to create")],
        ...
        :param create_organization_req_payload: The organization data that you want to create (required)
        :type create_organization_req_payload: CreateOrganizationReqPayload
        ...
        _param = self._create_organization_serialize(
            create_organization_req_payload=create_organization_req_payload,
    ...
    def _create_organization_serialize(
        self,
        create_organization_req_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_organization_req_payload is not None:
            _body_params = create_organization_req_payload
    ...
    def create_organization_api_key(
        ...
        create_api_key_req_payload: Annotated[CreateApiKeyReqPayload, Field(description="JSON request payload to create a new organization api key")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param create_api_key_req_payload: JSON request payload to create a new organization api key (required)
    ...
    def _create_organization_api_key_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/organization/api_key',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _delete_organization_api_key_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/organization/api_key/{api_key_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_organization_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OrganizationWithSubAndPlan]:
        """Get Organization
    ...
    def get_organization_api_keys_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ApiKeyRespBody]]:
        """Get Organization Api Keys
    ...
    def update_all_org_dataset_configs(
        self,
        tr_organization: Annotated[StrictStr, Field(description="The organization id to use for the request")],
        update_all_org_dataset_configs_req_payload: Annotated[UpdateAllOrgDatasetConfigsReqPayload, Field(description="The organization data that you want to create")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tr_organization: The organization id to use for the request (required)
        :type tr_organization: str
        :param update_all_org_dataset_configs_req_payload: The organization data that you want to create (required)
        :type update_all_org_dataset_configs_req_payload: UpdateAllOrgDatasetConfigsReqPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_all_org_dataset_configs_serialize(
            tr_organization=tr_organization,
            update_all_org_dataset_configs_req_payload=update_all_org_dataset_configs_req_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_all_org_dataset_configs_with_http_info(
        self,
        tr_organization: Annotated[StrictStr, Field(description="The organization id to use for the request")],
        update_all_org_dataset_configs_req_payload: Annotated[UpdateAllOrgDatasetConfigsReqPayload, Field(description="The organization data that you want to create")],
        _request_timeout: Union[
    ...
    @validate_call
    def update_all_org_dataset_configs_without_preload_content(
        self,
        tr_organization: Annotated[StrictStr, Field(description="The organization id to use for the request")],
        update_all_org_dataset_configs_req_payload: Annotated[UpdateAllOrgDatasetConfigsReqPayload, Field(description="The organization data that you want to create")],
        _request_timeout: Union[
    ...
    def _update_all_org_dataset_configs_serialize(
        self,
        tr_organization,
        update_all_org_dataset_configs_req_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_all_org_dataset_configs_req_payload is not None:
            _body_params = update_all_org_dataset_configs_req_payload
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/organization/update_dataset_configs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_organization(
        self,
        tr_organization: Annotated[StrictStr, Field(description="The organization id to use for the request")],
        update_organization_req_payload: Annotated[UpdateOrganizationReqPayload, Field(description="The organization data that you want to update")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tr_organization: The organization id to use for the request (required)
        :type tr_organization: str
        :param update_organization_req_payload: The organization data that you want to update (required)
        :type update_organization_req_payload: UpdateOrganizationReqPayload
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_organization_serialize(
            tr_organization=tr_organization,
            update_organization_req_payload=update_organization_req_payload,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_organization_serialize(
        self,
        tr_organization,
        update_organization_req_payload,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_organization_req_payload is not None:
            _body_params = update_organization_req_payload
