...
class TestRAGQueries(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RAGQueries:
        """Test RAGQueries
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RAGQueries`
        """
        model = RAGQueries()
        if include_optional:
            return RAGQueries(
