...
class TestRAGAnalyticsResponse(unittest.TestCase):
    """RAGAnalyticsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RAGAnalyticsResponse:
        """Test RAGAnalyticsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RAGAnalyticsResponse`
        """
        model = RAGAnalyticsResponse()
        if include_optional:
            return RAGAnalyticsResponse(
                queries = [
                    trieve_py_client.models.rag_query_event.RagQueryEvent(
                        created_at = '', 
                        dataset_id = '', 
                        id = '', 
                        rag_type = '', 
    ...
    def testRAGAnalyticsResponse(self):
        """Test RAGAnalyticsResponse"""
