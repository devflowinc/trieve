...
class TestRecommendationsWithClicksCTRResponse(unittest.TestCase):
    """RecommendationsWithClicksCTRResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecommendationsWithClicksCTRResponse:
        """Test RecommendationsWithClicksCTRResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecommendationsWithClicksCTRResponse`
        """
        model = RecommendationsWithClicksCTRResponse()
        if include_optional:
            return RecommendationsWithClicksCTRResponse(
                clicked_chunks = [
    ...
    def testRecommendationsWithClicksCTRResponse(self):
        """Test RecommendationsWithClicksCTRResponse"""
