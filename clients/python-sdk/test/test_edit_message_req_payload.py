...
class TestEditMessageReqPayload(unittest.TestCase):
    """EditMessageReqPayload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EditMessageReqPayload:
        """Test EditMessageReqPayload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EditMessageReqPayload`
        """
        model = EditMessageReqPayload()
        if include_optional:
            return EditMessageReqPayload(
    ...
    def testEditMessageReqPayload(self):
        """Test EditMessageReqPayload"""
