...
class TestSearchGroupResponseTypes(unittest.TestCase):
    """SearchGroupResponseTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchGroupResponseTypes:
        """Test SearchGroupResponseTypes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchGroupResponseTypes`
        """
        model = SearchGroupResponseTypes()
        if include_optional:
    ...
    def testSearchGroupResponseTypes(self):
        """Test SearchGroupResponseTypes"""
