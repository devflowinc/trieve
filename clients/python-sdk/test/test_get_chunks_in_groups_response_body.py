...
class TestGetChunksInGroupsResponseBody(unittest.TestCase):
    """GetChunksInGroupsResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetChunksInGroupsResponseBody:
        """Test GetChunksInGroupsResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetChunksInGroupsResponseBody`
        """
        model = GetChunksInGroupsResponseBody()
        if include_optional:
            return GetChunksInGroupsResponseBody(
                chunks = [
    ...
    def testGetChunksInGroupsResponseBody(self):
        """Test GetChunksInGroupsResponseBody"""
