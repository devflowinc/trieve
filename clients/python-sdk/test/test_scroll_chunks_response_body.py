...
class TestScrollChunksResponseBody(unittest.TestCase):
    """ScrollChunksResponseBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScrollChunksResponseBody:
        """Test ScrollChunksResponseBody
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScrollChunksResponseBody`
        """
        model = ScrollChunksResponseBody()
        if include_optional:
            return ScrollChunksResponseBody(
                chunks = [
    ...
    def testScrollChunksResponseBody(self):
        """Test ScrollChunksResponseBody"""
