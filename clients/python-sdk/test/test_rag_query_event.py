...
class TestRagQueryEvent(unittest.TestCase):
    """RagQueryEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RagQueryEvent:
        """Test RagQueryEvent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RagQueryEvent`
        """
        model = RagQueryEvent()
        if include_optional:
