...
The liquid template for the global component. Can be edited via an `App Embed`
![image](https://trieve.b-cdn.net/github/app-embeds.png)
...
## Setting `SHOPIFY_THEME_APP_EXTENSION_UUID` in your .env file
